		...
		<div id ="content">
			...
			<div id = "bbscontent" align = center >
				<table class="type02">
					<tr>
						<th>게시글 제목</th>
						<td><input type = "text" name = "btitle" id = "btitle" value = "${bbsVO.btitle}" style="width :100%; height : 30px;"></td>
						<!-- id는 ajax에서  쓰기위해 사용. name은 controller로 데이터를 넘겼을 때 vo가 인식할 수 있도록 이름 설정. -->
					</tr>
				  	<tr>
						<th>게시글 내용</th>
						<td><textarea rows="20" cols="100" name = "bcontent" id = "bcontent">${bbsVO.bcontent}</textarea></td> 
					</tr>
				  	<tr>
						<th>게시글 작성자</th>
						<td><input type = "text" name = "bwriter" value = <%= session.getAttribute("Mid")%> readonly style="width :100%; height : 30px;"></td>
					</tr>
					<tr>
						<td colspan="2"><button type ="button" id = "b1">게시글 수정</button></td>
					</tr>
				</table>
			</div>
		</div>
